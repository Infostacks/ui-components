...
let figmaIcons: figmaIconsProps = {
  ...
  bookmarkIcon: (fill) => {
    if (fill==='fill') {
      ...
      <path d="M12.89 5.87988H5.11C3.4 5.87988 2 7.27988 2 8.98988V20.3499C2 21.7999 3.04 22.4199 4.31 21.7099L8.24 19.5199C8.66 19.2899 9.34 19.2899 9.75 19.5199L13.68 21.7099C14.96 22.4099 16 21.7999 16 20.3499V8.98988C16 7.27988 14.6 5.87988 12.89 5.87988Z" fill="#3326c9"/>
      <path d="M22 5.11V16.47C22 17.92 20.96 18.53 19.69 17.83L17.76 16.75C17.6 16.66 17.5 16.49 17.5 16.31V8.99C17.5 6.45 15.43 4.38 12.89 4.38H8.81996C8.44996 4.38 8.18996 3.99 8.35996 3.67C8.87996 2.68 9.91996 2 11.11 2H18.89C20.6 2 22 3.4 22 5.11Z" fill="#3326c9"/>
    </svg>
