...
export interface HInputFeildProps {
    ...
    svgStart: 'user' | 'email' | 'password' | 'check' | 'eyeOpen' | 'eyeClosed' | null,
    svgEnd: 'user' | 'email' | 'password' | 'check' | 'eyeOpen' | 'eyeClosed' | null,
...
* @param {string} height - Height of div
...
*/
export default function HInputFeild({type, height, value, onChange, onClick, placeholder, background, svgStart, svgEnd, required, styles, register, error}:HInputFeildProps) {
   const SVGS = {
